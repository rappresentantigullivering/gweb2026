        ...
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              ...
              <a href="https://github.com/rappresentantigullivering/gweb2026" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className={styles.social} id="footer-github">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.linkCol}>
            ...
            <ul className={styles.linkList}>
              ...
              <li><a href="https://www.unionedegliuniversitari.it/">UDU</a></li>
            </ul>
          </div>
        ...
        <div className={styles.bottom}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
            ...
            <p style={{ fontSize: '0.75rem', color: 'var(--gray-500)', marginTop: '0.25rem' }}>
              Per problemi <strong>esclusivamente tecnici</strong>: <a href="mailto:cali@gulliverancona.it" style={{ textDecoration: 'underline' }}>cali@gulliverancona.it</a>
            </p>
          </div>
