      ...
      <section className="section">
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <h2 style={{ marginBottom: '2rem' }}>Le nostre proposte per i Dottorandi</h2>
            ...
            <div style={{ marginTop: '4rem', padding: '3rem', background: 'var(--dark)', borderRadius: 'var(--radius-2xl)', color: '#fff', textAlign: 'center' }}>
              ...
              <p style={{ opacity: 0.8, marginBottom: '2rem' }}>Scarica il documento completo in formato PDF per leggere tutte le proposte dedicate ai dottorandi.</p>
              <a 
