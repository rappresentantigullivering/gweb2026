...
export const metadata: Metadata = {
  title: "Programma Medicina | Gulliver UNIVPM",
      ...
      <section className="section">
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <h2 style={{ marginBottom: '2.5rem', fontWeight: 800 }}>Punti salienti per Medicina</h2>
            ...
            <div style={{ 
              ...
              <p style={{ opacity: 0.9, marginBottom: '2.5rem', fontSize: '1.1rem' }}>Leggi la proposta integrale per Medicina scaricando il PDF ufficiale.</p>
              <a 
                href="/docs/programmi/PROGRAMMA MEDICINA 2026.pdf" 
