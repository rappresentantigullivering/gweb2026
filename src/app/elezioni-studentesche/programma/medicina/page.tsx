      ...
      <section className="section">
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <h2 style={{ marginBottom: '2rem' }}>Punti salienti per Medicina</h2>
            ...
            <div style={{ 
              ...
              <p style={{ opacity: 0.9, marginBottom: '2rem' }}>Leggi la proposta integrale per Medicina scaricando il PDF ufficiale.</p>
              <a 
