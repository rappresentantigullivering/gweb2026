      ...
      <section className={styles.content}>
        <div className="container">
          <div className={styles.embedContainer}>
            <iframe 
              style={{ border: "1px solid rgba(255, 255, 255, 0.1)", borderRadius: "16px", background: "transparent" }} 
              width="100%" 
              height="600" 
              src="https://embed.figma.com/proto/HKHvjvNoJlGHCOxTFY1fE8/UnivPM?node-id=122-68&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=122%3A68&embed-host=share" 
              allowFullScreen
          ...
          <div className={styles.info}>
            <div className={styles.card}>
              ...
              <div style={{ marginTop: '2rem' }}>
                <Link href="https://uvote2.cineca.it/static/redir.html?idp=samlUnivpm" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-lg">
