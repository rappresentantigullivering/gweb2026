...
export const metadata: Metadata = {
  ...
  description: "The Gulliver International Student Guide for the academic year 2026/2027.",
};
      ...
      <section className="section" style={{ padding: '4rem 1.5rem 8rem' }}>
        <div className="container" style={{ maxWidth: '700px' }}>
          <div className="card" style={{
            ...
            <h2 style={{ fontSize: '1.8rem', fontWeight: 800 }}>Download the International Student Guide</h2>
            
            <p style={{ fontSize: '1.05rem', color: 'var(--gray-600)', maxWidth: '500px', lineHeight: 1.7 }}>
              Consult the document to find all the useful information regarding ERDIS scholarships, enrollment, tuition waivers, and the student portal.
            </p>
